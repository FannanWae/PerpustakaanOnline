...
$id = $_GET['id'];
$knd = "WHERE id = $id";
$sql = "SELECT * FROM sumber_lain $knd";
...
<body>
    ...
    <div class="container" id="container">
        ...
        <div class="tampil">
            <div class="rowtampil">
                <div class="img">
                    <img class="imgg" src="gambar/sumberlain/<?= $value['gambar']?>" alt="">
                </div>
            <div class="detail">
                <h3>Judul   : <?= $value['judul_buku']?> </h3><br>
                <h3>Penulis : <?= $value['penulis']?> </h3><br>
                <h3>Penerbit : <?= $value['penerbit']?></h3><br>
                <h5> <?= $value['catatan']?> </h5>
            </div>
            </div>  
        </div>
