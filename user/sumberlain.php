...
<body>
    ...
    <div class="container" id="container">
        ...
        <div class="books">
            <div class="rowbook">
            <?php
                $result = mysqli_query($koneksi,"SELECT * FROM sumber_lain ORDER BY id DESC");
                while($val = mysqli_fetch_array($result)){
                ?>
                <div class="boxbook">
                    <img src="gambar/sumberlain/<?= $val['gambar'] ?>" alt="">
                    <div class="text">
                    <a href="tampil_lain.php?id=<?= $val['id'] ?>" style="color: white; text-decoration:none;"><h3><?=$val['judul_buku']?></h3></a>
                    </div> 
                </div>
                <?php } ?>
            </div>
